...
class fakeValidateHospital(object):
    def __init__(self, body, isvalidated):
        self.body = body
...
def test_adminHomePage_validate(mock_fl_re, mock_vho_validate, mock_flash, mock_fl_ren, mock_hlo_li):
    ...
    mock_vho_validate.return_value = fakeValidateHospital({"hospital": "hospital1", "validate": "true"}, "True")
    mock_fl_ren.return_value = "<h2>admin page</h2>"
    adminviews.adminHomepage()
...
@mock.patch.object(adminviews, 'request')
def test_adminHomePage_delete(mock_fl_re, mock_dho_delete, mock_flash, mock_fl_ren, mock_hlo_li):
    mock_hlo_li.return_value = fakeHospitalList("{\"hospitals\": \"[('hospital1', 'hospital1@test.com', 'address hospital1'), ('hospital2', 'hospital2@test.com', 'address hospital2')]")
    adminviews.request.method = 'POST'
...
def test_adminHomePage_certificate():
    pass

def test_adminHomePage_certificate_failed():
    pass
