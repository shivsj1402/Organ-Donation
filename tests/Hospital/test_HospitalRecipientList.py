...
@mock.patch.object(hrlo.hc, 'getHospitalName')
def test_getRecipientList(mock_hospital_reclist):
    mock_hospital_reclist.return_value = [("Pratik", "Kapoor", "pratik.kapoor90@gmail.com", "Halifax")]
...
@mock.patch.object(hrlo.hc, 'getHospitalName')
def test_getRecipientList(mock_hospital_reclist):
    mock_hospital_reclist.return_value = None
    hosRecipientList = hrlo.HospitalRecipientList("IWK",logging.getLogger())
    assert hosRecipientList.getRecipientList() == None
