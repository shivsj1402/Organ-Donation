...
def test_createDonationRequest_pass(mock_donation__create_req):
    ...
    mock_donor_object = newdonationrequesttest.NewDonationRequest("donor@gmail.com","receipent@gmail.com","heart","iwk")
...
def test_createDonationRequest_exception(mock_donation__create_req):
    ...
    mock_donor_object = newdonationrequesttest.NewDonationRequest("","","","")
